...
function merge(e,r){for(var t in r)has.call(r,t)&&null!=r[t]&&(e||(e={}),e[t]="object"===type(r[t])?merge(e[t],r[t]):r[t]);return e}var has=Object.prototype.hasOwnProperty;try{var type=require("type-component")}catch(err){var type=require("type")}module.exports=merge;
});
...
require("./d3"),module.exports=d3,function(){delete this.d3}();
});
require.register("trevorgerhardt-stylesheet/index.js", function(exports, require, module){
function StyleSheet(e,t){return this instanceof StyleSheet?(this.variables={},this.rules={},e&&this.add(e),t&&this.define(t),void 0):new StyleSheet(e,t)}function createStyleSheetElement(){var e=document.createElement("style"),t=document.getElementsByTagName("head")[0];return t.appendChild(e),e}function generateCSS(e,t){var r,n="";for(var i in e){n+=i+"{";for(var l in e[i])r=e[i][l],isFunction(r)&&(r=r()),n+=l+":"+r+";";n+="}"}for(var s in t)r=t[s],isFunction(r)&&(r=r()),n=n.replace(new RegExp("@"+s,"gi"),r);return n}function isFunction(e){return"[object Function]"===Object.prototype.toString.call(e)}var merge=require("merge-util");module.exports=StyleSheet,StyleSheet.prototype.define=function(e){return this.variables=merge(this.variables,e),this},StyleSheet.prototype.add=function(e){return this.rules=merge(this.rules,e),this},StyleSheet.prototype.render=function(){return this.el||(this.el=createStyleSheetElement()),this.el.innerHTML=generateCSS(this.rules,this.variables),this},StyleSheet.prototype.clear=function(){return this.el.innerHTML="",this.rules="",this.variables={},this},StyleSheet.prototype.remove=function(){var e=this.el;return e&&e.parentNode&&(e.parentNode.removeChild(e),this.el=null),this};
});
require.register("yields-svg-attributes/index.js", function(exports, require, module){
module.exports=["height","target","title","width","y1","y2","x1","x2","cx","cy","dx","dy","rx","ry","d","r","y","x"];
});
require.register("transitive/lib/graph/edge.js", function(exports, require, module){
function Edge(t,e,r){this.stopArray=t,this.fromVertex=e,this.toVertex=r,this.calculateVectors()}module.exports=Edge,Edge.prototype.pointAlongEdge=function(t){var e=this.fromVertex.x+t*(this.toVertex.x-this.fromVertex.x),r=this.fromVertex.y+t*(this.toVertex.y-this.fromVertex.y);return{x:e,y:r}},Edge.prototype.calculateVectors=function(){var t=this.fromVertex.x-this.toVertex.x,e=this.fromVertex.y-this.toVertex.y,r=Math.sqrt(t*t+e*e);this.vector={x:t/r,y:e/r},this.leftVector={x:-this.vector.y,y:this.vector.x},this.rightVector={x:this.vector.y,y:-this.vector.x}},Edge.prototype.toString=function(){return this.fromVertex.stop.getId()+"_"+this.toVertex.stop.getId()};
});
require.register("transitive/lib/graph/index.js", function(exports, require, module){
function NetworkGraph(){this.vertices=[],this.edges=[]}function equal(e,r){if(e.length!==r.length)return!1;for(var t in e)if(e[t]!==r[t])return!1;return!0}var Edge=require("./edge"),Vertex=require("./vertex");module.exports=NetworkGraph,NetworkGraph.prototype.addVertex=function(e,r,t){r||(r=e.stop_lon),t||(t=e.stop_lat);var o=new Vertex(e,r,t);return this.vertices.push(o),o},NetworkGraph.prototype.addEdge=function(e,r,t){if(-1===this.vertices.indexOf(r))return console.log("Error: NetworkGraph does not contain Edge fromVertex"),void 0;if(-1===this.vertices.indexOf(t))return console.log("Error: NetworkGraph does not contain Edge toVertex"),void 0;var o=new Edge(e,r,t);return this.edges.push(o),r.edges.push(o),t.edges.push(o),o},NetworkGraph.prototype.getEquivalentEdge=function(e,r,t){for(var o=0;o<this.edges.length;o++){var n=this.edges[o];if(n.fromVertex===r&&n.toVertex===t&&e.length===n.stopArray.length&&equal(e,n.stopArray))return n}};
});
require.register("transitive/lib/graph/vertex.js", function(exports, require, module){
function Vertex(t,e,o){this.stop=t,this.x=e,this.y=o,this.edges=[]}module.exports=Vertex,Vertex.prototype.moveTo=function(t,e){this.x=t,this.y=e,this.edges.forEach(function(t){t.calculateVectors()})};
});
require.register("transitive/lib/styler/computed.js", function(exports, require, module){
function showLabelsOnHover(e,s){e.selectAll(".transitive-stop-circle").on("mouseenter",function(s){e.select("#transitive-stop-label-"+s.stop.getId()).style("visibility","visible")}).on("mouseleave",function(t){s.zoom.scale()<s.labelZoomThreshold&&e.select("#transitive-stop-label-"+t.stop.getId()).style("visibility","hidden")})}module.exports=[showLabelsOnHover];
});
require.register("transitive/lib/styler/index.js", function(exports, require, module){
function Styler(t,e){return this instanceof Styler?(this.computed=require("./computed"),this.passive=require("./passive"),this.stylesheet=new StyleSheet,this.load(t,e),void 0):new Styler}function applyAttrAndStyle(t,e,r){function i(t){return function(i,s){return isFunction(t)?t.call(r,i,e,s):t}}for(var s in r){var n=-1===svgAttributes.indexOf(s)?"style":"attr";t[n](s,i(r[s]))}}function isFunction(t){return"[object Function]"===Object.prototype.toString.call(t)}var merge=require("merge-util"),StyleSheet=require("stylesheet"),svgAttributes=require("svg-attributes");svgAttributes.push("transform"),module.exports=Styler,Styler.prototype.load=function(t,e){t&&(this.passive=merge(this.passive,t)),e&&(this.computed=this.computed.concat(e))},Styler.prototype.render=function(t,e){for(var r in this.passive)applyAttrAndStyle(t.selectAll(r),e,this.passive[r]);this.computed.forEach(function(r){r(t,e)})},Styler.prototype.reset=function(){this.passive={},this.computed=[]};
});
require.register("transitive/lib/styler/passive.js", function(exports, require, module){
module.exports={".transitive-stop-circle":{cx:0,cy:0,fill:"white",r:5,stroke:"none"},".transitive-stop-label":{color:"black","font-family":"sans-serif","font-size":function(t){return"S3"===t.stop.stop_id?"20px":"10px"},transform:function(){return"rotate(-45, "+this.x+", "+this.y+")"},visibility:function(t,i){return i.zoom.scale()<.75?"hidden":"visible"},x:0,y:-12},".transitive-line":{stroke:"blue","stroke-width":"15px",fill:"none"}};
});
require.register("transitive/lib/display.js", function(exports, require, module){
function Display(t,e){this.offsetLeft=t.offsetLeft,this.offsetTop=t.offsetTop,this.labelZoomThreshold=.75,this.initScales(t,e),this.zoom=d3.behavior.zoom().scaleExtent([.25,4]),this.svgGroup=this.svg=d3.select(t).append("svg").append("g"),this.svgGroup.call(this.zoom),this.svg.append("rect").attr("class","overlay"),this.setElement(t)}var d3=require("d3");module.exports=Display,Display.prototype.setElement=function(t){var e=t.clientWidth,i=t.clientHeight;this.xScale.range([0,e]),this.yScale.range([i,0]),this.zoom.x(this.xScale).y(this.yScale),this.svg.attr("width",e).attr("height",i),this.svg.select("rect").attr("width",e).attr("height",i)},Display.prototype.initScales=function(t,e){var i=Number.MAX_VALUE,s=-Number.MAX_VALUE,a=Number.MAX_VALUE,h=-Number.MAX_VALUE;e.vertices.forEach(function(t){i=Math.min(i,t.x),s=Math.max(s,t.x),a=Math.min(a,t.y),h=Math.max(h,t.y)});var l,o,r,n,c,m=s-i,p=h-a,d=t.clientWidth/t.clientHeight,f=m/(0===p?Number.MIN_VALUE:p),v=.2;if(d>f){l=v*p,n=a-l,c=h+l;var g=(p+2*l)*d,u=(s+i)/2;o=u-g/2,r=u+g/2}else{l=v*m,o=i-l,r=s+l;var y=(m+2*l)/d,x=(h+a)/2;n=x-y/2,c=x+y/2}this.xScale=d3.scale.linear().domain([o,r]),this.yScale=d3.scale.linear().domain([n,c])};
});
require.register("transitive/lib/pattern.js", function(exports, require, module){
function Pattern(t){for(var e in t)"stops"!==e&&(this[e]=t[e]);this.stops=[],this.graphEdges=[]}var d3=require("d3");module.exports=Pattern,Pattern.prototype.draw=function(t,e){var s=this.stops;this.svgGroup=t.svg.append("g"),this.line=d3.svg.line().x(function(r,o){var i,h=r.x;return i=0===o?t.xScale(h)+e*r.outEdge.vector.x:o===s.length-1?t.xScale(h)-e*r.inEdge.vector.x:t.xScale(h),r.offsetX&&(i-=r.offsetX),i}).y(function(r,o){var i,h=r.y;return i=0===o?t.yScale(h)-e*r.outEdge.vector.y:o===s.length-1?t.yScale(h)+e*r.inEdge.vector.y:t.yScale(h),r.offsetY&&(i+=r.offsetY),i}).interpolate("linear"),this.lineGraph=this.svgGroup.append("path").attr("class","transitive-line"),this.stopSvgGroups=this.svgGroup.selectAll(".transitive-stop").data(this.getStopData()).enter().append("g"),this.stopSvgGroups.append("circle").attr("class","transitive-stop-circle"),this.stopSvgGroups.append("text").attr("id",function(t){return"transitive-stop-label-"+t.stop.getId()}).text(function(t){return t.stop.stop_name}).attr("class","transitive-stop-label")},Pattern.prototype.refresh=function(t){var e=this.lineGraph.style("stroke-width");this.lineWidth=parseInt(e.substring(0,e.length-2),10);var s=this.getStopData();this.lineGraph.attr("d",this.line(s)),this.stopSvgGroups.data(s),this.stopSvgGroups.attr("transform",function(e){var s=t.xScale(e.x)-e.offsetX,r=t.yScale(e.y)+e.offsetY;return"translate("+s+", "+r+")"})},Pattern.prototype.getStopData=function(){var t=[];return this.graphEdges.forEach(function(e,s){s>0?this.graphEdges[s-1]:null;var r,o=s<this.graphEdges.length-1?this.graphEdges[s+1]:null;if(0===s&&(r={x:e.fromVertex.x,y:e.fromVertex.y,stop:e.fromVertex.stop,inEdge:null,outEdge:e},r.offsetX=this.offset?e.rightVector.x*this.lineWidth*this.offset:0,r.offsetY=this.offset?e.rightVector.y*this.lineWidth*this.offset:0,t.push(r)),e.stopArray.forEach(function(s,o){r=e.pointAlongEdge((o+1)/(e.stopArray.length+1)),r.stop=s,r.inEdge=r.outEdge=e,this.offset?(r.offsetX=e.rightVector.x*this.lineWidth*this.offset,r.offsetY=e.rightVector.y*this.lineWidth*this.offset):r.offsetX=r.offsetY=0,t.push(r)},this),r={x:e.toVertex.x,y:e.toVertex.y,stop:e.toVertex.stop,inEdge:e,outEdge:null},this.offset)if(o&&o.rightVector.x!==e.rightVector.x&&o.rightVector.y!==e.rightVector.y){var i={x:o.rightVector.x+e.rightVector.x,y:o.rightVector.y+e.rightVector.y},h=Math.sqrt(i.x*i.x+i.y*i.y),n={x:i.x/h,y:i.y/h},a=Math.sqrt(Math.pow(o.rightVector.x-e.rightVector.x,2)+Math.pow(o.rightVector.y-e.rightVector.y,2))/2,f=1/Math.sqrt(1-a*a);r.offsetX=n.x*this.lineWidth*this.offset*f,r.offsetY=n.y*this.lineWidth*this.offset*f}else r.offsetX=e.rightVector.x*this.lineWidth*this.offset,r.offsetY=e.rightVector.y*this.lineWidth*this.offset;else r.offsetX=r.offsetY=0;t.push(r)},this),t},Pattern.prototype.getGraphVertices=function(){var t=[];return this.graphEdges.forEach(function(e,s){0===s&&t.push(e.fromVertex),t.push(e.toVertex)}),t};
});
require.register("transitive/lib/route.js", function(exports, require, module){
function Route(t){for(var e in t)"patterns"!==e&&(this[e]=t[e]);this.patterns=[]}module.exports=Route,Route.prototype.addPattern=function(t){this.patterns.push(t),t.route=this};
});
require.register("transitive/lib/stop.js", function(exports, require, module){
function Stop(t){for(var o in t)"patterns"!==o&&(this[o]=t[o]);this.patterns=[]}module.exports=Stop,Stop.prototype.getId=function(){return this.stop_id};
});
require.register("transitive/lib/transitive.js", function(exports, require, module){
function Transitive(t,e,r,s){return this instanceof Transitive?(this.graph=new Graph,this.load(e),this.display=new Display(t,this.graph),this.display.zoom.on("zoom",this.refresh.bind(this)),this.style=new Styler(r,s),this.render(),void 0):new Transitive(t,e,r,s)}function generateStops(t){var e={};return t.forEach(function(t){e[t.stop_id]=new Stop(t)}),e}function populateGraphEdges(t,e){var r=null,s=[];for(var i in t){var a=t[i];r=null;for(var n in a.stops){var o=a.stops[n];if(o.graphVertex){if(null!==r){var p=e.getEquivalentEdge(s,r,o.graphVertex);p||(p=e.addEdge(s,r,o.graphVertex)),a.graphEdges.push(p)}r=o.graphVertex,s=[]}else s.push(o)}}}var d3=require("d3"),Display=require("./display"),Graph=require("./graph"),Pattern=require("./pattern"),Route=require("./route"),Stop=require("./stop"),Styler=require("./styler");module.exports=Transitive,module.exports.d3=d3,module.exports.version="0.0.0",Transitive.prototype.load=function(t){this.stops=generateStops(t.stops),this.routes={},this.patterns={};var e={};t.routes.forEach(function(t){var r=new Route(t);this.routes[r.route_id]=r,t.patterns.forEach(function(t){var s=new Pattern(t);this.patterns[t.pattern_id]=s,r.addPattern(s),t.stops.forEach(function(t){var e=this.stops[t.stop_id];s.stops.push(e),e.patterns.push(s)},this);var i=s.stops[0];i.getId()in e||(e[i.getId()]=i);var a=s.stops[s.stops.length-1];a.getId()in e||(e[a.getId()]=a)},this)},this);for(var r in e){var s=e[r],i=this.graph.addVertex(s,0,0);s.graphVertex=i}populateGraphEdges(this.patterns,this.graph)},Transitive.prototype.render=function(){var t=this.display,e=t.offsetLeft,r=t.offsetTop,s=this.refresh.bind(this),i=d3.behavior.drag().on("dragstart",function(){d3.event.sourceEvent.stopPropagation()}).on("drag",function(i){i.stop.graphVertex&&(i.stop.graphVertex.moveTo(t.xScale.invert(d3.event.sourceEvent.pageX-e),t.yScale.invert(d3.event.sourceEvent.pageY-r)),s())});for(var a in this.patterns){var n=this.patterns[a];n.draw(this.display,10),n.stopSvgGroups.selectAll(".transitive-stop-circle").call(i)}s()},Transitive.prototype.refresh=function(){for(var t in this.patterns){var e=this.patterns[t];this.style.render(e.svgGroup,this.display),e.refresh(this.display)}},Transitive.prototype.setElement=function(t){this.display.setElement(t),this.render()};
});
