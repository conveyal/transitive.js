...
function drawGrid(display, cellSize) {
  var svg = display.svg;
  var xScale = display.xScale;
  var yScale = display.yScale;

  var appendLine = function appendLine(x1, x2, y1, y2) {
    grid.append('line').attr('class', 'gridline').attr('x1', x1).attr('x2', x2).attr('y1', y1).attr('y2', y2);
  };
