...
var _d3Geo = require('./d3.geo.tile');
...
function TileLayer(opts) {
  ...
  var projection = _d2.default.geo.mercator().translate([width / 2, height / 2]);

  // Set up the map tiles
  var tile = (0, _d3Geo2.default)();

  // Create the tile layer
  var tileLayer = _d2.default.select(el).append('div').attr('class', 'tile-layer');
  ...
  // Render tiles
  var renderTiles = function renderTiles(tiles) {
...
//# sourceMappingURL=tile-layer.js