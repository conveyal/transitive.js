...
Transitive.prototype.updateGeometry = function(snapGrid) {
  ...
  if(snapGrid) this.graph.snapToGrid((this.options && this.options.gridCellSize) ? this.options.gridCellSize : 0.01);
...
Transitive.prototype.populateRenderSegments = function() {
  ...
  this.graph.edges.forEach(function(edge) {
    ...
    var renderSegment = new Segment(edge.pathSegments[0].type);
    renderSegment.pattern = edge.pathSegments[0].pattern;
