...
var Labeler = augment(Object, function () {
  ...
  this.updateQuadtree = function() {
    ...
    this.quadtree = d3.geom.quadtree().extent([[0, 0], [this.width, this.height]])([]);
  ...
  this.doLayout = function() {
    ...
    this.points.forEach(function(point) {
      ...
      var labelText = point.getName();
      //console.log(' - placing label: '+labelText);
