...
Edge.prototype.getGeometricCoords = function(fromOffsetPx, toOffsetPx, display, forward) {
  ...
  each(geomCoords, function(coord, i) {
    ...
    var fromVector, fromOffsetX = 0, fromOffsetY = 0
    ...
    fromVector = Util.normalizeVector(fromVector);
    ...
    var fromOffsetX = fromOffsetPx * fromRightVector.x;
    var fromOffsetY = fromOffsetPx * fromRightVector.y;
