...
Edge.prototype.getRenderCoords = function(fromOffsetPx, toOffsetPx, display) {
  ...
  var len = null, x1, y1, x2, y2;

  if((isBase && !this.isStraight()) || (!isBase && this.baseRenderCoords.length === 4)) {

    var isect = Util.rayIntersection(fx, fy, fvx, fvy, tx, ty, tvx, tvy);
    //var isect = Util.lineIntersection(fx, fy, fx + fvx, fy + fvy, tx, ty, tx + tvx, ty + tvy);
    if(isect.intersect) {
      var u = isect.u;
      var ex = fx + fvx * u;
      var ey = fy + fvy * u;
...
Edge.prototype.pointAlongEdgeCurve = function(t, fromOffsetX, fromOffsetY, toOffsetX, toOffsetY) {
