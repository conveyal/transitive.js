...
Edge.prototype.calculateGeometry = function() {


  this.elbow = this.getCurveElbow();
...
Edge.prototype.align = function(vertex, vector) {
  if(this.aligned || !this.elbow) return;
  var currentVector = this.getVector(vertex);
  if(currentVector.x !== vector.x || currentVector.y !== vector.y) {
