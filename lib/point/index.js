...
var Stop = augment(Object, function () {
  ...
  this.constructMergedCircle = function(display) {
    ...
    var patternRadius = display.styler.compute(display.styler.stops_pattern.r, display, { 'point': this });
  ...
  this.constructMergedPolygon = function(display) {
