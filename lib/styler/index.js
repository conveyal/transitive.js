...
var types = [ 'labels', 'segments', 'stops_merged', 'stops_pattern', 'places', 'multipoints' ];
...
Styler.prototype.renderMultiPoint = function(display, place) {
  this.applyAttrAndStyle(
    display,
  ...
  this.applyAttrAndStyle(
    display,
    place.svgGroup.selectAll('.transitive-multipoint-label'),
    this.labels
  );
};
