...
exports.stops_pattern = {
  ...
  stroke: [
    ...
    function (display, data) {
      if(!data.point.isPatternFocused(data.segment.pattern.getId())) return notFocusedColor;
...
exports.multipoints_merged = {
  fill: [
    '#fff',
    function (display, data) {
      if(data.point.containsFromPoint()) return '#0f0';
      if(data.point.containsToPoint()) return '#f00';
    }
  ],
  r: [
    6,
    function (display, data) {
      if(data.point.containsFromPoint() || data.point.containsToPoint()) return 10;
    }
  ],
  stroke: [
    '#000',
    function (display, data) {
      if(data.point.containsFromPoint() || data.point.containsToPoint()) return '#fff';
      if(!data.point.focused) return notFocusedColor;
    }
  ],
  'stroke-width': [
    4,
    function (display, data) {
      if(data.point.containsFromPoint() || data.point.containsToPoint()) return 3;
    }
  ],
  visibility: [ function(display, data) {
    return 'visible';
...
exports.segments = {
  stroke: [
    '#008',
    function (display, data) {
      if(!data.focused) return notFocusedColor;
  ...
  'stroke-width': [
    ...
    function (display, data, index, utils) {
      ...
      if(data.pattern.route.route_type === 3) {
...
exports.segment_label_containers = {
  fill: [
    '#008',
    function (display, data) {
      if(!data.segment.focused) return notFocusedColor;
    }
  ],
  rx: [
    3
